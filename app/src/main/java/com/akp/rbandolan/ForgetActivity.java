...
public class ForgetActivity extends AppCompatActivity {
    ...
    private void openURL() {
        if (!isNetworkAvailable()) {
            ...
            String domain="https://rbandolan.com/";
            ...
            webview.setWebViewClient(new WebViewClient() {
                ...
                public boolean shouldOverrideUrlLoading(WebView view, String url) {
                    ...
                    Log.v("dfdgdrgh",url);
                    if(url.equalsIgnoreCase("https://rbandolan.com/"))
                    {
                        Toast.makeText(getApplicationContext(), "forgot Successfully", Toast.LENGTH_SHORT).show();
                ...
                public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                    Toast.makeText(ForgetActivity.this, "Error:" + description, Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            Uri result = intent == null || resultCode != ForgetActivity.RESULT_OK ? null : intent.getData();
